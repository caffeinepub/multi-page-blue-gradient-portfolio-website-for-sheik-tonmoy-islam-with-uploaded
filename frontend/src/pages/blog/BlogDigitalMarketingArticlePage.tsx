...
export default function BlogDigitalMarketingArticlePage() {
  const navigate = useNavigate();
  const article = blogArticles.find((a) => a.id === 'digital-marketing')!;

  useEffect(() => {
    setSEO({
      title: article.seoTitle,
      description: article.seoDescription,
      keywords: `digital marketing, ${article.category}, marketing strategies, SEO, social media marketing`,
      ogTitle: article.seoTitle,
      ogDescription: article.seoDescription,
      ogImage: article.image,
      canonicalUrl: getCanonicalSiteUrl() + '/blog/digital-marketing',
    });
  }, [article]);
