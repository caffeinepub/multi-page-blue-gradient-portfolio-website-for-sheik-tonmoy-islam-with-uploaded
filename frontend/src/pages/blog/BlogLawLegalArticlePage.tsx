...
export default function BlogLawLegalArticlePage() {
  const navigate = useNavigate();
  const article = blogArticles.find((a) => a.id === 'law-legal')!;

  useEffect(() => {
    setSEO({
      title: article.seoTitle,
      description: article.seoDescription,
      keywords: `law, legal services, ${article.category}, legal consulting, compliance`,
      ogTitle: article.seoTitle,
      ogDescription: article.seoDescription,
      ogImage: article.image,
      canonicalUrl: getCanonicalSiteUrl() + '/blog/law-legal',
    });
  }, [article]);
