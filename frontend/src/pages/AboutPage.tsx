...
export default function AboutPage() {
  useEffect(() => {
    setSEO({
      ...
      description:
        'Learn about Sheik Tonmoy Islam, a multi-disciplinary professional combining legal expertise, business consulting, digital marketing, graphic design, video editing, and web development skills to deliver comprehensive solutions.',
      keywords: 'about Sheik Tonmoy Islam, legal consultant, business professional, digital marketer, graphic designer, video editor, web developer',
      ogTitle: 'About Sheik Tonmoy Islam - Multi-Disciplinary Professional',
      ogDescription: 'Combining legal expertise with creative and technical skills to deliver comprehensive solutions.',
      canonicalUrl: getCanonicalSiteUrl() + '/about',
    });
  }, []);
